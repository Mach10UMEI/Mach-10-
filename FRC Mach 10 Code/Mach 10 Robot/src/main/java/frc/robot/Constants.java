...
public final class Constants {
    // Motors
    public static final int DRIVER_BACK_ID = 4;
    public static final int PASSNGER_FRONT_ID =1;
    public static final int PASSNGER_BACK_ID = 2;
    public static final int DRIVER_FRONT_ID = 3;
